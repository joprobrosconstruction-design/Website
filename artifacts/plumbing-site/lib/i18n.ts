...
export const translations = {
  en: {
    ...
    home: {
      ...
      heroLine1: "Quality Work,",
      heroWord1: "Every Time.",
      heroLine2: "Any Job,",
      heroWord2: "Any Size.",
      heroDesc:
        "From fixing a leaky faucet to handling a full commercial buildout, we show up on time, get the job done right, and stand behind every single one of our projects.",
  ...
  es: {
    ...
    home: {
      ...
      heroLine1: "Trabajo de Calidad,",
      heroWord1: "Siempre.",
      heroLine2: "Cualquier Trabajo,",
      heroWord2: "Cualquier Tamaño.",
      heroDesc:
        "Desde arreglar una llave que gotea hasta terminar una obra comercial completa, llegamos a tiempo, hacemos el trabajo bien y respondemos por cada proyecto.",
