...
export default function CareersPage() {
  ...
  const handleApplyClick = (positionTitle: string) => {
    ...
    if (select) select.value = positionTitle;
  ...
  const benefits = [
    ...
    { Icon: HeartPulse, title: c.benefit2Title, desc: c.benefit2Desc },
    { Icon: GraduationCap, title: c.benefit3Title, desc: c.benefit3Desc },
    { Icon: Briefcase, title: c.benefit4Title, desc: c.benefit4Desc },
  ];
    ...
    <main className="min-h-screen bg-background pt-24 pb-24">
      ...
      <section className="bg-foreground text-primary-foreground py-20 relative overflow-hidden mb-16">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center max-w-4xl">
          ...
          <p className="text-xl text-primary-foreground/80 mb-8">{c.heroDesc}</p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 md:px-6 max-w-4xl">
        <div className="glass p-8 md:p-12 rounded-3xl border border-border/50 shadow-sm relative overflow-hidden">
          ...
          <h2 className="text-3xl font-bold mb-8 text-foreground relative z-10">{c.formTitle}</h2>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select id="position" name="position" required className={selectCls} defaultValue="">
              ...
              <div className="space-y-2">
                ...
                <select id="experience" name="experience" required className={selectCls} defaultValue="">
                  ...
                  <option value="Entry Level">{c.optEntryLevel}</option>
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold text-foreground" htmlFor="coverLetter">
                  {c.labelCoverLetter}
                </label>
                <textarea
                  id="coverLetter"
                  ...
                  placeholder={c.placeholderCoverLetter}
                ></textarea>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-foreground block">{c.idLabel}</label>
                  <label className="flex items-center justify-center w-full px-4 py-6 border-2 border-dashed rounded-xl cursor-pointer hover:bg-muted/50 transition-colors bg-background/30 text-center">
                    <input
                      type="file"
                      name="id"
